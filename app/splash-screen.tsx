  ...
  return (
    <div className={`xingliuSplash ${leaving ? "xingliuSplashLeaving" : ""}`} aria-hidden="true">
      <style jsx global>{`
        ...
        .orbitOne{top:10%;left:-15%}
        .orbitTwo{bottom:5%;left:-18%;transform:rotate(-17deg);border-color:rgba(70,118,255,.2)}
        ...
        .xingliuBrand{position:relative;z-index:2;display:flex;align-items:center;flex-direction:column;transform:translateY(-2vh)}
        ...
        .xingliuTagline{position:absolute;z-index:2;bottom:22%;font-size:14px;letter-spacing:6px;color:rgba(238,240,255,.78);text-shadow:0 0 15px rgba(120,135,255,.2)}
        ...
        .xingliuLoading:after{content:"";display:block;width:62%;height:100%;border-radius:999px;background:linear-gradient(90deg,#43a8ff,#7a59ff);box-shadow:0 0 12px rgba(93,109,255,.7);animation:xingliuLoad 1.65s ease-out forwards}
        ...
        @media (prefers-reduced-motion:reduce){.xingliuSplash,.xingliuStars,.xingliuLoading:after{animation:none!important;transition:none!important}}
      `}</style>
