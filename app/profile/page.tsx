  ...
  return <main className="page">
    <style jsx global>{`
      *{box-sizing:border-box}
      ...
      .sheet{position:relative;z-index:5;margin-top:-1px;background:#fff;border-radius:10px 10px 0 0;min-height:650px;padding-top:4px}
      ...
      .bottom{position:fixed;z-index:30;left:0;right:0;bottom:0;height:55px;background:#fff;border-top:1px solid #eee;display:grid;grid-template-columns:repeat(5,1fr);padding-bottom:env(safe-area-inset-bottom)}.nav{display:flex;flex-direction:column;align-items:center;justify-content:center;gap:3px;font-weight:700;font-size:12px;color:#676870}.nav.active{color:#17181d}.publish{width:38px;height:32px;border:2px solid #17181d;border-radius:11px;display:grid;place-items:center;background:#fff}
