  ...
  return <main className="page">
    <style jsx global>{`
      *{box-sizing:border-box}
      ...
      .page{min-height:100dvh;background:#f6f7f8;padding-bottom:74px;overflow-x:hidden}
      ...
      .grid{display:grid;grid-template-columns:repeat(3,1fr);gap:2px;background:#f3f3f3}.tile{position:relative;aspect-ratio:3/4;background:#ddd;overflow:hidden}.tile img,.tile video{width:100%;height:100%;object-fit:cover}.tileShade{position:absolute;inset:55% 0 0;background:linear-gradient(transparent,#0008)}.draft{position:absolute;left:8px;top:8px;background:#fff;color:#333;padding:5px 8px;border-radius:5px;font-size:12px;font-weight:750}.tileMeta{position:absolute;bottom:7px;left:8px;color:#fff;font-size:12px;text-shadow:0 1px 5px #000}.empty{text-align:center;padding:75px 20px 140px;color:#999}.empty a{display:inline-block;margin-top:10px;color:#f13b62;font-weight:750}
      .bottom{position:fixed;z-index:30;left:0;right:0;bottom:env(safe-area-inset-bottom);height:55px;background:#fff;border-top:1px solid #eee;display:grid;grid-template-columns:repeat(5,1fr);padding-bottom:0}.nav{display:flex;flex-direction:column;align-items:center;justify-content:center;gap:3px;font-weight:700;font-size:12px;color:#676870;min-height:55px}.nav.active{color:#17181d}.publish{width:38px;height:32px;border:2px solid #17181d;border-radius:11px;display:grid;place-items:center;background:#fff}
